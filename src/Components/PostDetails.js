...
import postNotFound from './Utils/icons/post-not-found.jpg';
    ...
    render(){
      ...
      return (
        <div>
          ...
          {(Object.keys(post).length===0 && !this.props.details.loading) &&
            <div className="deleted-post">
              <img src={postNotFound} alt="Post not found"/>
              <div><a href="/">Go Back to Safety</a></div>
            </div>
          } 
        </div>
      )
...
function mapDispatchToProps (dispatch) {
  return {
    ...
    changeCommentsSort: (sort) => dispatch(Actions.changeCommentsSort(sort)),
